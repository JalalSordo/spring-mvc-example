...
@EnableJpaRepositories(basePackages = { "com.everis.example.repository" })
...
public class ModelConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("com.everis.example.model");
	...
	Properties additionalProperties() {
		return new Properties() {
			...
			{ // Hibernate Specific:
				setProperty("hibernate.hbm2ddl.auto", env.getProperty("database.hibernate.hbm2ddl.auto"));
				...
				setProperty("hibernate.hbm2ddl.import_files",
						env.getProperty("database.hibernate.hbm2ddl.import_files"));
			}
		};
	}
}